...
$config['modules'][$module_name]['fields'] = array(
										...
										'category' => array( 'label' => 'Categoria',
																	...
																	'options' => array(
																						...
																						5 => array("value" => "rojos y violetas", "label" => "Rojos y violetas"),
																						6 => array("value" => "cenizas irisados", "label" => "Cenizas Irisados"),
																						7 => array("value" => "aclarantes", "label" => "Aclarantes"),
																						8 => array("value" => "crazy colors", "label" => "Crazy Colors"),
																						9 => array("value" => "rubios", "label" => "Rubios"),
																						10 => array("value" => "rojos", "label" => "Rojos"),
																						11 => array("value" => "negros", "label" => "Negros"),
																						),
